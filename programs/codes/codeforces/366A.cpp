...
int main()
{
   ...
   int mi1 = 10000000,mi2 = 10000000;
   REP(i,8)	mi1 = min(mi1,B[i]);
   REP(i,8)	mi2 = min(mi2,J[i]);
   REP(i,4)
   {
   		if(B[2*i] == mi1 && B[2*i+1] == mi1)
   		{
   			if(2 * mi1 <= n)	
   			{
   				printf("%d %d %d\n",i+1,mi1 , n-mi1);
